...
/** 
 * DAO for table "HISTORY_FILE".
*/
public class HistoryFileDao extends AbstractDao<HistoryFile, Long> {

    public static final String TABLENAME = "HISTORY_FILE";

    /**
     * Properties of entity HistoryFile.<br/>
    ...
    public HistoryFileDao(DaoConfig config) {
        super(config);
    }
    
    public HistoryFileDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HISTORY_FILE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HISTORY_FILE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, HistoryFile entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, HistoryFile entity) {
        stmt.clearBindings();
    ...
    @Override
    public HistoryFile readEntity(Cursor cursor, int offset) {
        HistoryFile entity = new HistoryFile( //
    ...
    @Override
    public void readEntity(Cursor cursor, HistoryFile entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(HistoryFile entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(HistoryFile entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(HistoryFile entity) {
